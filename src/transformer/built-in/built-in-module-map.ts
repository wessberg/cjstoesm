...
export const BUILT_IN_MODULE_MAP: BuiltInModuleMap = {
	...
	path: {
		namedExports: new Set(["resolve", "normalize", "isAbsolute", "join", "relative", "toNamespacedPath", "dirname", "basename", "extname", "format", "parse", "sep", "delimiter", "win32", "posix"]),
		hasDefaultExport: true
	},
	perf_hooks: {
	...
	worker_threads: {
		namedExports: new Set(["isMainThread", "MessagePort", "MessageChannel", "moveMessagePortToContext", "threadId", "SHARE_ENV", "Worker", "parentPort", "workerData"]),
		hasDefaultExport: true
	},
	zlib: {
		namedExports: new Set([
